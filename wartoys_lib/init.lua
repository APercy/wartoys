...
if(minetest.get_translator ~= nil) then
    wartoys_lib.S = minetest.get_translator(minetest.get_current_modname())
...
wartoys_lib.is_creative = minetest.settings:get_bool("creative_mode", false)
wartoys_lib.can_collect_car = minetest.settings:get_bool("collect_wartoys", true)
...
function wartoys_lib.swap_node(self, pos)
    ...
    if have_air then
        minetest.set_node(target_pos, {name='wartoys_lib:light'})
...
function wartoys_lib.put_light(self)
    ...
    if n and n.name == 'air' then
        minetest.set_node(pos, {name='wartoys_lib:light'})
...
function wartoys_lib.destroy(self, puncher)
    ...
    if wartoys_lib.can_collect_car == false then
        --minetest.add_item({x=pos.x+math.random()-0.5,y=pos.y,z=pos.z+math.random()-0.5},'wartoys_lib:engine')
    else
...
minetest.register_node("wartoys_lib:light", {
	drawtype = "airlike",
	--tile_images = {"wartoys_light.png"},
	inventory_image = minetest.inventorycube("wartoys_light.png"),
	paramtype = "light",
	walkable = false,
...
dofile(minetest.get_modpath("wartoys_lib") .. DIR_DELIM .. "physics_lib.lua")
...
dofile(minetest.get_modpath("wartoys_lib") .. DIR_DELIM .. "inventory_management.lua")
dofile(minetest.get_modpath("wartoys_lib") .. DIR_DELIM .. "formspecs.lua")
dofile(minetest.get_modpath("wartoys_lib") .. DIR_DELIM .. "entities.lua")
dofile(minetest.get_modpath("wartoys_lib") .. DIR_DELIM .. "shells.lua")
