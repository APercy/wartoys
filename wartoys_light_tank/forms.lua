...
function light_tank.driver_formspec(name)
    ...
    minetest.show_formspec(name, "light_tank:driver_main", basic_form)
end

minetest.register_on_player_receive_fields(function(player, formname, fields)
	if formname == "light_tank:driver_main" then
        ...
        minetest.close_formspec(name, "light_tank:driver_main")
    end
end)
